...
(function(global){
	...
	var ermsresource = (function(){
		...
		function log(msg, doAlert){
			...
			if (debugMode && global.console && global.console.log){
				global.console.log('ermsresource.js : ' + msg);
			}
			// alert messages if needed
			if (doAlert === true){
				alert('ermsresource.js : ' + msg);
			}
		}
	...
	if ( typeof define === 'function' && define.amd ) {
		...
		// set global 
		if (!global.ermsresource){
			global.ermsresource = ermsresource;
		}
	}
